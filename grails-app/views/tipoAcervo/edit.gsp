...
<html>
	...
	<body>
		...
		<div class="row">
			...
			<g:hasErrors bean="${tipoAcervoInstance}">
				<div class="alert alert-warning alert-dismissible" role="alert">
				  	<button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
					<ul class="errors" role="alert">
						<g:eachError bean="${tipoAcervoInstance}" var="error">
			...
			<div class="col-lg-12">
		        <div class="panel panel-primary">
		            <div class="panel-heading">
	                	<i class="fa fa-pencil fa-fw"></i><g:message code="default.edit.label" args="[entityName]" />
		            </div>
		            <div class="panel-body">
		            	<g:form url="[resource:tipoAcervoInstance, action:'update']" method="PUT"  role="form">
							<g:hiddenField name="version" value="${tipoAcervoInstance?.version}" />
