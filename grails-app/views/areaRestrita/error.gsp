...
<body>
	<form action="${request.contextPath}/j_spring_security_check"
		...
		<div class="erroLogin">Houve um erro na tentativa anterior de
			entrada no sistema.</div>

		<div class="row">
			<div class="col-lg-12">
				<table>
					<tr>
						<td width="100" height="50" class="negrito">Usu&aacute;rio:</td>
						<td><input type="text" name="j_username" id="username"
							size="40" /></td>
					</tr>

					<tr>
						<td class="negrito">Senha:</td>
						<td><input type="password" name="j_password" id="password"
							size="40" /></td>
					</tr>
					<tr>
						<td colspan="2" style="padding-top: 10px" align="right"><input
							type="submit" value="Entrar" class="btn btn-default" /></td>
					</tr>
				</table>
			</div>
			<!-- /.col-lg-12 -->
